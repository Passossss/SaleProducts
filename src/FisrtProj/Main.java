...
public class Main {
    /*public static void main(String[] args) {
        FisrtProj.Camisa camisa1 = new FisrtProj.Camisa("M", "Branca", 50.00f);
        FisrtProj.Calca calca1 = new FisrtProj.Calca("38", "Jeans", 80.00f);
        FisrtProj.Vestido vestido1 = new FisrtProj.Vestido("P", "Floral", 120.00f);
